...
CREATE TABLE IF NOT EXISTS `config` (
  ...
  `desc` varchar(256) DEFAULT NULL COMMENT 'Long description of setting',
...
-- Dumping data for table configuration.config: ~32 rows (approximately)
/*!40000 ALTER TABLE `config` DISABLE KEYS */;
INSERT INTO `config` (`setting`, `type`, `name`, `dispname`, `value`, `desc`, `admin`) VALUES
	...
	(34, 1, 'security_salt_len', 'Password Salt Length', '32', 'The length of the password salt in bytes.', 1),
	(35, 1, 'security_hash_rounds', 'Password Hash Rounds', '100', 'Number of times to hash password + salt for password encryption.', 1),
	(36, 1, 'security_hashtime_min', 'Password Hashtime Minimum', '10', 'Minimum jitter time for password hashing.', 0),
	(37, 1, 'security_hashtime_max', 'Password Hashtime Maximum', '500', 'Maximum jitter time for password hashing.', 0),
	(38, 1, 'security_passexp_timeout', 'Password Expire Timeout', '7776000', 'Maximum allowed time between password changes. When this is exceeded, the user will be forced to change their password.', 1),
	(39, 1, 'security_login_failure_lockout', 'Allowed Login Failure Attempts', '5', 'The maximum number of login failure attempts before the account is locked out.', 1),
	(40, 1, 'security_lockout_time', 'Account Lockout Time', '900', 'The amount of time the account is locked out after the number of login failure attempts have been exceeded.', 1),
	...
	(72, 1, 'profile_id_admin', 'Vendor Profile ID', '-1', 'The profile ID number of the vendor account.', 0),
	(73, 1, 'profile_id_vendor', 'Admin Profile ID', '-2', 'The profile ID number of the administrator account.', 0);
...
CREATE TABLE IF NOT EXISTS `module` (
  ...
  `desc` varchar(256) DEFAULT NULL COMMENT 'A description of the module.',
...
INSERT INTO `profile` (`profileid`, `name`, `desc`, `portal`, `bitmap_core`, `bitmap_app`) VALUES
	(-2, 'admin', 'The profile for use by the administrator account.  Special Profile.', 1, NULL, NULL),
	(-1, 'vendor', 'The profile for use by the vendor account.  Special Profile.', 1, NULL, NULL),
	(0, 'NONE', 'This indicates no profile.  Special Profile.', 1, NULL, NULL),
	(1, 'manager', 'Profile to be assigned to management accounts.', 1, NULL, NULL);
